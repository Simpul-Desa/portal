...
function bacaPortalUrl(): string {
  const nilai = process.env.NEXT_PUBLIC_PORTAL_URL;
  return (nilai || "http://localhost:3000").replace(/\/+$/, "");
}
...
export const PORTAL_URL = bacaPortalUrl();
