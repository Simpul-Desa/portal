...
export interface PrismProps extends React.HTMLAttributes<HTMLDivElement> {
  height?: number;
  baseWidth?: number;
    ...
    const fragment = `
      ...
      void main(){
        ...
        if (uLightMode > 0.5) {
          ...
          // Fade cleanly to pure white (#ffffff / vec3(1.0)) outside the active prism refraction
          float intensity = smoothstep(0.04, 0.28, o.a) * 0.92;
          gl_FragColor = vec4(mix(vec3(1.0), chroma, intensity), 1.0);
        } else {
